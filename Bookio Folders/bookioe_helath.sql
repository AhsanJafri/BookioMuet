...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2019 at 12:02 PM
...
INSERT INTO `mcqs` (`M_ID`, `M_ques`, `Year`, `C_ID`, `Sub_ID`, `optionone`, `optiontwo`, `optionthree`, `optionfour`, `answer`, `Class`) VALUES
(20, 'What is the formula of common salt ?', '2018', 1, 3, 'NaNO3', 'NaCl', 'CaCO3', 'Ca(CO)3', 'NaCl', 'Inter');
...
--
-- Table structure for table `writing_contest`
--

CREATE TABLE `writing_contest` (
  `ID` int(255) NOT NULL,
...
--
-- Dumping data for table `writing_contest`
--

INSERT INTO `writing_contest` (`ID`, `Name`, `Email`, `Contact`, `Address`, `City`, `File`) VALUES
(19, 'Salman', 'asadsadsdsad', '0332094542', 'fsfssfsfs', 'Jamshoro', 'wireless_communication_tutorial.pdf'),
(20, 'Salman', 'asadsadsdsad', '0332094542', 'fsfssfsfs', 'Jamshoro', 'wireless_communication_tutorial.pdf');
...
--
-- Indexes for table `writing_contest`
--
ALTER TABLE `writing_contest`
  ADD PRIMARY KEY (`ID`);
...
--
ALTER TABLE `mcqs`
  MODIFY `M_ID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
...
--
-- AUTO_INCREMENT for table `writing_contest`
--
ALTER TABLE `writing_contest`
